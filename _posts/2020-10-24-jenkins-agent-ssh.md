...
- agent에서 ssh 설정
    ...
    - Windows 10의 Openssh 서비스를 이용([https://lucidmaj7.tistory.com/178](https://lucidmaj7.tistory.com/178))
        - Windows **설정**에서 **앱**으로 진입
            ...
            ![jenkins_ssh_res/Untitled.png](jenkins_ssh_res/Untitled.png)

        - 앱에서 **선택적 기능**으로 진입

            ![jenkins_ssh_res/Untitled%201.png](jenkins_ssh_res/Untitled%201.png)

        - **기능 추가** 로 진입

            ![jenkins_ssh_res/Untitled%202.png](jenkins_ssh_res/Untitled%202.png)

        - 검색창에서 openssh입력하여 설치

            ![jenkins_ssh_res/Untitled%203.png](jenkins_ssh_res/Untitled%203.png)

    - sshd 서비스 실행
        - powershell을 관리자 권한으로 오픈

            ![jenkins_ssh_res/Untitled%204.png](jenkins_ssh_res/Untitled%204.png)

        - sshd 서비스를 자동실행으로 등록

            ![jenkins_ssh_res/Untitled%205.png](jenkins_ssh_res/Untitled%205.png)
    ...
    - public key인증 방식으로 변경([https://medium.com/beyond-the-windows-korean-edition/windows-10-네이티브-방식으로-ssh-서버-설정하기-64988d87349](https://medium.com/beyond-the-windows-korean-edition/windows-10-%EB%84%A4%EC%9D%B4%ED%8B%B0%EB%B8%8C-%EB%B0%A9%EC%8B%9D%EC%9C%BC%EB%A1%9C-ssh-%EC%84%9C%EB%B2%84-%EC%84%A4%EC%A0%95%ED%95%98%EA%B8%B0-64988d87349))
        ...
        - jenkins agent 설정
            - Jenkins >> Jenkins 관리 >> 노드 관리 >> 신규 노드
                ...
                ![jenkins_ssh_res/Untitled%206.png](jenkins_ssh_res/Untitled%206.png)

            - 기본 설정

                ![jenkins_ssh_res/Untitled%207.png](jenkins_ssh_res/Untitled%207.png)

            - 고급 설정에서 port과 command 설정

                ![jenkins_ssh_res/Untitled%208.png](jenkins_ssh_res/Untitled%208.png)
        ...
        - powersell용 스크립트 파일을 생성하여 작업 스캐줄러에 등록
            ...
            - 작업 스캐줄러 등록
                - - ExecutionPolicy Bypass C:\Users\{Username}\wslbridge.ps1
                    ...
                    ![jenkins_ssh_res/Untitled%209.png](jenkins_ssh_res/Untitled%209.png)

        - jenkins agent 설정
            - 기본 설정

                ![jenkins_ssh_res/Untitled%2010.png](jenkins_ssh_res/Untitled%2010.png)

            - 고급 설정

                ![jenkins_ssh_res/Untitled%2011.png](jenkins_ssh_res/Untitled%2011.png)
...
- master에서 ssh 설정(비대칭 암호키 사용)
    ...
    - jenkins credentials 추가
        - Jenkins >> Jenkins 관리 >> Manage Credentials >> (global) >> Add Credentials
            ...
            ![jenkins_ssh_res/Untitled%2012.png](jenkins_ssh_res/Untitled%2012.png)

        - 아까 생성한 비밀키를 입력(C:\Users\{Username}\.ssh\id_rsa)

            ![jenkins_ssh_res/Untitled%2013.png](jenkins_ssh_res/Untitled%2013.png)
